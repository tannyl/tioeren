...
**Bemærk:** Loft-semantik gælder **kun for udgifter**. Indtægtsposter er flade (ingen børn tilladt), så loft-beregning er ikke relevant for indtægt.
...
**Sletning af budgetposter:**

Når en budgetpost slettes (soft delete), frigives eventuelle børn som selvstændige rodposter. Børnene beholder deres `container_ids` og `category_path` uændret. De er ikke længere begrænset af forfaderens beholder-pulje eller beløbsloft.
...
3. For udgift:
   ...
   - Valgfrit: angiv via-beholder (gennemløbskasse, kun relevant for ikke-pengekasser)
   - Valgfrit: slå akkumulering til (ubrugt beløb overføres til næste periode)
4. For overførsel:
   - Vælg fra-beholder og til-beholder (alle beholdertyper, skal være forskellige)
5. Tilføj beløbsmønstre
